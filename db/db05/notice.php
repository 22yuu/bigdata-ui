<?
	...
	$startRow=($page-1)*10;
	// $url="http://yuubug.dothome.co.kr/myadmin";
	// $db_id = "yuubug";
	// $db_pw = "dlwlsdb11##";
	//$conn = mysqli_connect("url","yuubug","dlwlsdb11##","yuubug");
	$conn = mysqli_connect("localhost","root","autoset","mydb");
	$sql = "select * from notice order by no desc limit $startRow, 10";//desc / asc
	...
	<div id="wrap">
		...
		<div class="content" >
			...
			<form name="frm_search" method="post" action="notice_search_result.php">
				...
				<input type="button" class="bt" name="btn-search" value="검색" onclick="location.href='notice_search_result?content=$content' search()">
			</form>
			</div>
