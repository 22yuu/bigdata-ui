...
<div id="form">
	...
	<table class="table1" style="width:600px">
		...
		//이전 5개로 돌아가기
		if($pageGroup > 1) {
			echo "<a href='qna_search_result.php?page=1&selected=$selected&searchString=$str'>첫 페이지로</a>";
		...
		$endPage = ($startPage+4);
			...
			if($pageGroup<$pageGroupCount) {
				...
				echo "<a href='qna_search_result.php?page=$pageCount&selected=$selected&searchString=$str'>마지막으로</a>";
			}
