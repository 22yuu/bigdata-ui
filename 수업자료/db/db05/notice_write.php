	...
	<div id="wrap">
		...
		<div class="content" style="text-align: center">
			...
			<table class="table1">
				<tr>
					<th>제목</th>
					<td><input type="text" name="notice-title" style="width:300px"></td>
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea name="notice-content" style="width:300px; height: 200px;"></textarea></td>
				</tr>
				<tr>
					<td colspan="2">
						<input type="button" value="작성 완료" onclick="done()">
					</td>
				</tr>
			</table>
		</div>
